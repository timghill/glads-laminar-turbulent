...
ax2.plot(yang_2016_density[:, 0], yang_2016_density[:, 1], label='Target density', color='coral')
ax2.plot(z_bin_center, density_bins, label='Synthetic density', color='teal')
