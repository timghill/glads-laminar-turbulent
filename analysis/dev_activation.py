...
if __name__=='__main__':
    fname = '../glads/dev_00_synth_forcing_scaling/RUN/output_005_seasonal.nc'
    figname = 'figures/aux/dev_00_activation.png'
    fig = plot_activation(fname, figname, tlim=[3, 9])

    fname = '../glads/dev_01_kan_forcing_scaling/RUN/output_005_seasonal.nc'
    figname = 'figures/aux/dev_01_activation.png'
    fig = plot_activation(fname, figname, tlim=[4, 10])


    fname = '../glads/dev_01_kan_forcing_scaling/RUN/output_405_seasonal.nc'
    figname = 'figures/aux/dev_01_activation_40X.png'
    fig = plot_activation(fname, figname, tlim=[4, 10])

    fname = '../glads/dev_01_kan_forcing_scaling/RUN/output_505_seasonal.nc'
    figname = 'figures/aux/dev_01_activation_50X.png'
    fig = plot_activation(fname, figname, tlim=[4, 10])
