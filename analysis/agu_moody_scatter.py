...
def plot_moody(fnames, fignames, colors=defaults.colors, omega=1/2000,
    ...
    ax_scatter.legend(bbox_to_anchor=[1.05, 0, 0.5, 1],
...
if __name__=='__main__':
    ...
    models = ['Turbulent 5/4', 'Turbulent 3/2', 'Laminar', 'Transition 5/4', 'Transition 3/2']
    fignames = ['figures/main/00_moody_composite_theory.png', 'figures/aux/agu_00_moody_composite_scatter.png']
    ...
    models = ['Turbulent 5/4', 'Turbulent 3/2', 'Laminar', 'Transition 5/4', 'Transition 3/2']
    fignames = ['figures/aux/01_moody_composite_theory.png', 'figures/aux/agu_01_moody_composite_scatter.png']
    plot_moody(fnames, fignames, models=models)
