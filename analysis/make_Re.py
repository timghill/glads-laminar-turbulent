...
figname = '00_pressure_seasonal_SHMIP.png'
...
fig_00 = plot_Re(fnames, figname, Qmin=10, Qmax=200)

## Case 00.2: Flat topo, SHMIP forcing, consistent para
cases = [201, 202, 203, 204, 205]
fnames = ['../glads/00_shmip_forcing_shmip_topo/RUN/output_%03d_seasonal.nc'%caseid for caseid in cases]
figname = '00_presure_seasonal_SHMIP_200.png'
fig_00 = plot_pressure_maps_timeseries(fnames, figname, Qmin=10, Qmax=200)
...
fig_01 = plot_pressure_maps_timeseries(fnames, figname, Qmin=10, Qmax=200)

## Case 02a: Trough topo, SHMIP forcing
cases = [1, 2, 3, 4, 5]
pattern = '../glads/02a_shmip_forcing_valley_topo/RUN/output_%03d_seasonal.nc'
fnames = [pattern % caseid for caseid in cases]
figname = '02a_pressure_seasonal.png'
fig_02 = plot_pressure_maps_timeseries(fnames, figname, Qmin=10, Qmax=100)
...
fig_02 = plot_pressure_maps_timeseries(fnames, figname, Qmin=10, Qmax=200)
...
fig_03 = plot_pressure_maps_timeseries(fnames, figname, Qmin=1)
