...
def plot_moody(fnames, fignames, colors=defaults.colors, omega=1/2000,
    ...
    for ii in range(len(fnames)):
        ...
        scatter_xs.append(Re.flatten())
        scatter_ys.append(f_D.flatten())
    ...
    checknames = [  'moody_scatter_01.png',
                    'moody_scatter_02.png',
                    'moody_scatter_03.png']
    for ii in range(len(fnames)):
        Re = scatter_xs[ii]
        f_D = scatter_ys[ii]
        if models[ii]=='Turbulent 3/2':
        ...
        if models[ii]=='Laminar':
            ...
            ax_scatter.scatter(Re, f_D, color=colors[ii], label=models[ii], s=2, alpha=1, zorder=10, edgecolor='none')
...
if __name__=='__main__':
    ...
    fnames = ['/home/tghill/projects/def-gflowers/tghill/laminar-turbulent/glads/01_kan_forcing/RUN/output_%03d_seasonal.nc'%cid for cid in cases]
    models = ['Turbulent 5/4', 'Turbulent 3/2', 'Laminar', 'Transition 5/4', 'Transition 3/2']
    fignames = ['moody_composite_theory.png', 'moody_composite_scatter.png']
    plot_moody(fnames, fignames, models=models)
