...
pin.bed_elevation = make_anon_fn('@(xy, time) double(bed_elevation_valley_reversed(xy, time))');
pin.ice_thickness = make_anon_fn('@(xy, time) double(ice_thickness_valley_reversed(xy, time, pin))', pin);
