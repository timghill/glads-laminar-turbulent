...
fig_00 = plot_Re(fnames, figname, Qmin=10, Qmax=200, Re_ylim=(0, 2e3))
...
fig_00 = plot_Re(fnames, figname, Qmin=1, Qmax=100, Re_ylim=(0, 2e3))
...
fig_01 = plot_Re(fnames, figname, Qmin=1, Qmax=100, Re_ylim=(0, 2e3))
...
fig_01 = plot_Re(fnames, figname, Qmin=10, Qmax=200, Re_ylim=(0, 2e3))
...
fig_02 = plot_Re(fnames, figname, Qmin=10, Qmax=100, Re_ylim=(0, 2e3))
...
fig_02 = plot_Re(fnames, figname, Qmin=10, Qmax=200, Re_ylim=(0, 2e3))
...
fig_03 = plot_Re(fnames, figname, Qmin=1, Re_ylim=(0, 2e3))
